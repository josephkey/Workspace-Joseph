# com-chilipeppr-workspace-joseph
A ChiliPeppr Workspace joseph.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / joseph
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-joseph |
| Name                  | Workspace / joseph |
| Description           | A ChiliPeppr Workspace joseph. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/josephkey/Workspace-Joseph/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/josephkey/workspace-joseph |
| Github URL            | http://github.com/josephkey/Workspace-Joseph |
| Test URL              | https://preview.c9users.io/josephkey/workspace-joseph/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/josephkey/Workspace-Joseph/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-joseph"], // the id you gave your workspace
      function(myWorkspaceJoseph) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / joseph just got loaded.", myWorkspaceJoseph);
        myWorkspaceJoseph.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-joseph"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / joseph"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace joseph."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/josephkey/Workspace-Joseph/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/josephkey/workspace-joseph"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/josephkey/Workspace-Joseph"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-joseph-josephkey.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
